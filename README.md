...
![Disco-modus op de ledstrip](images/m09-disco-strip.jpeg)
...
2. Een NeoPixel-ledstrip (WS2812B) met 16 LEDs, aangesloten met drie draden: data (geel) op **D1**, plus (rood) op 3V en GND (zwart) op g
...
6. Een **2,4 GHz**-wifinetwerk, bijvoorbeeld de hotspot van je telefoon, bij hotspot zorg dat maximaliseer compatibiteit aanstaat
...
![BotFather start-menu](images/01-botfather-start.png)

Stuur `/newbot`. BotFather vraagt eerst om een naam (ik koos _Callister_) en daarna om een gebruikersnaam die moet eindigen op `bot` (ik koos _Callister_MCU_bot_). Daarna krijg je je **token**. Die heb je zo nodig.

![Een nieuwe bot aanmaken met /newbot](images/02-botfather-newbot.png)
...
![Library UniversalTelegramBot](images/03-library-universaltelegrambot.png)
...
![Library ArduinoJson](images/04-library-arduinojson.png)
...
![Placeholders in EchoBot](images/05-echobot-placeholders.png)
...
![Ingevulde gegevens met de fout in de wifinaam](images/06-credentials-fout.png)

Kies bovenin het juiste board (**NodeMCU 1.0 (ESP-12E Module)**) en de juiste poort via **Tools → Port**.

![Board kiezen](images/07-board-selectie.png)

![Tools-menu met board en poort](images/08-tools-menu.png)
...
![Serial Monitor met alleen puntjes](images/09-fout-wifi-puntjes.png)
...
![Wifi verbonden](images/10-wifi-verbonden.png)
...
![De bot echoot berichten](images/m01-echo-werkt.jpeg)
...
![Originele handleNewMessages](images/11-echo-origineel.png)
...
![Serial.println toegevoegd](images/12-echo-println.png)
...
>
> ![Alleen got response](images/13-got-response.png)

**✅ Resultaat:** de tekst verschijnt in de Serial Monitor.

![Berichten in de Serial Monitor](images/18-monitor-berichten.png)
...
![Code met de tekst op de verkeerde plek](images/14-fout-parsemode-code.png)

![Berichten komen binnen](images/15-fout-parsemode-monitor.png)

![Geen antwoord in Telegram](images/m02-fout-geen-antwoord.jpeg)
...
![Compileerfout](images/16-fout-compileerfout.png)
...
![Werkende sendMessage](images/17-sendmessage-goed.png)

![Welkomstbericht in Telegram](images/m10-welkomstbericht.jpeg)
...
![pinMode LED_BUILTIN](images/19-pinmode-builtin.png)
...
![if / else if met LED_BUILTIN](images/20-ifelse-builtin.png)
...
>
> **Waarom LOW = aan?** De ingebouwde LED van de NodeMCU is _active low_: hij brandt als de pin LOW is. Dat is omgekeerd van wat je zou verwachten.
...
![Unknown command door een hoofdletter](images/m04-fout-hoofdletter.jpeg)
...
![toLowerCase en trim](images/27-lowercase-trim.png)
...
![Blauwe LED op het board brandt, strip is uit](images/m03-builtin-led-aan.jpeg)
...
![LED_PIN gedefinieerd](images/21-define-ledpin.png)

![pinMode met LED_PIN](images/22-pinmode-ledpin.png)
...
![Commando's werken in Telegram](images/m05-lights-commando.jpeg)

![Code met digitalWrite op LED_PIN](images/23-fout-digitalwrite-ledpin.png)
...
![Include NeoPixel](images/24-include-neopixel.png)
...
![Defines voor de strip](images/25-define-neopixel.png)
...
![Het pixels-object](images/26-pixels-object.png)
...
![pixels.begin in setup](images/29-pixels-begin.png)
...
![NeoPixel aan en uit](images/28-neopixel-aan-uit.png)
...
| --------------------------------------- | --------------------------------------- |
| ![Strip aan](images/m06-strip-aan.jpeg) | ![Strip uit](images/m07-strip-uit.jpeg) |
...
![Disco-variabelen](images/30-disco-variabelen.png)
...
![Unknown command aangepast](images/32-unknown-command.png)
...
![bool discoModus in de if](images/31-disco-commando.png)
...
![Disco-code in de verkeerde functie](images/33-disco-animatie.png)
...
![Disco-commando in Telegram](images/m08-disco-commando.jpeg)

![Disco-modus op de strip](images/m09-disco-strip.jpeg)
...
- Docent HvA CMD. _Telegram Adafruit ESP8266_ (beschrijving ToDo 4). [SharePoint](https://icthva.sharepoint.com/:w:/s/FDMCI_ORG__CMD-Amsterdam/Eb7Jd27yWphMuVFbMHV_9WoBEg5_zqAQilsb6Q3gPSKueg?e=f5PM7l)
- Dekker, K. (2023). _Cheap-Philips-Hue_ (voorbeeldmanual). [GitHub](https://github.com/Kvdekker/Cheap-Philips-Hue/blob/main/README.md)
- Lough, B. _Universal-Arduino-Telegram-Bot_ (library en EchoBot-voorbeeld). [GitHub](https://github.com/witnessmenow/Universal-Arduino-Telegram-Bot)
- Blanchon, B. _ArduinoJson_. [arduinojson.org](https://arduinojson.org)
- Adafruit. _Adafruit NeoPixel Library_. [GitHub](https://github.com/adafruit/Adafruit_NeoPixel)
- Adafruit. _Adafruit NeoPixel Überguide_. [learn.adafruit.com](https://learn.adafruit.com/adafruit-neopixel-uberguide)
- Telegram. _Telegram Bot API_. [core.telegram.org](https://core.telegram.org/bots/api)
- ESP8266 Arduino Core. _Documentatie (WiFi)_. [arduino-esp8266.readthedocs.io](https://arduino-esp8266.readthedocs.io)
- Arduino. _Arduino IDE_. [arduino.cc](https://www.arduino.cc/en/software)
- Anthropic. _Claude_ (AI-assistent), gebruikt als hulp bij het debuggen en het uitleggen van foutmeldingen.
